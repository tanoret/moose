...
#include "LinearFVMultiPhaseMomentumBuoyancy.h"
#include "Assembly.h"
#include "SubProblem.h"
#include "NS.h"
#include "FEProblemBase.h"

registerMooseObject("NavierStokesApp", LinearFVMultiPhaseMomentumBuoyancy);

InputParameters
LinearFVMultiPhaseMomentumBuoyancy::validParams()
{
...
LinearFVMultiPhaseMomentumBuoyancy::LinearFVMultiPhaseMomentumBuoyancy(const InputParameters & params)
...
Real
LinearFVMultiPhaseMomentumBuoyancy::computeMatrixContribution()
{
  return 0.0;
}

Real
LinearFVMultiPhaseMomentumBuoyancy::computeRightHandSideContribution()
{
                                            ...
                                            const bool /*elem_has_info*/)
  {
    ...
    const Real rho_alpha_prime_f = (rho_f - _rho_0) * _alpha(face_arg, state);  // Boussinesq/dynamic form
    rhs += rho_alpha_prime_f * _gravity(_index) * surface_vector(_index);       // ∑_faces (\rho' g_i) (n_i A)_f
  };
