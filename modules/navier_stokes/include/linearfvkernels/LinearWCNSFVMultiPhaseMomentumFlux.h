...
class RhieChowMassFluxMultiPhase;
 ...
 * equation.
 */
class LinearWCNSFVMultiPhaseMomentumFlux : public LinearFVFluxKernel
{
public:
   ...
   */
  LinearWCNSFVMultiPhaseMomentumFlux(const InputParameters & params);
...
/// The functor for the phase fraction
