...
[LinearFVKernels]
  ...
  []
  [u_drag_p1]
    type = LinearFVMultiPhaseDrag
    variable = 'vel_x_p1'
    drag_coeff = 'interphase_drag'
    coupled_velocity = 'vel_x_p2'
  []
  [v_drag_p1]
    type = LinearFVMultiPhaseDrag
    variable = 'vel_y_p1'
    drag_coeff = 'interphase_drag'
    coupled_velocity = 'vel_y_p2'
  []
  [w_drag_p1]
    type = LinearFVMultiPhaseDrag
    variable = 'vel_z_p1'
    drag_coeff = 'interphase_drag'
    coupled_velocity = 'vel_z_p2'
  []
  ...
  [u_drag_p2]
    ...
    variable = 'vel_x_p2'
    drag_coeff = 'interphase_drag'
    coupled_velocity = 'vel_x_p1'
  []
  [v_drag_p2]
    type = LinearFVMultiPhaseDrag
    variable = 'vel_y_p2'
    drag_coeff = 'interphase_drag'
    coupled_velocity = 'vel_y_p1'
  []
  [w_drag_p2]
    type = LinearFVMultiPhaseDrag
    variable = 'vel_z_p2'
    drag_coeff = 'interphase_drag'
    coupled_velocity = 'vel_z_p1'
  []
...
[LinearFVBCs]
  ...
  [inlet_w_p1]
    type = LinearFVAdvectionDiffusionFunctorDirichletBC
    variable = vel_z_p1
    functor = pump_mass_flow_fraction
    boundary = 'inlet'
  []
...
[FunctorMaterials]
  [drag_material]
    type = WCNSFV2PInterphaseDragFunctorMaterial
    u = vel_x_p1
    v = vel_y_p1
    w = vel_z_p1
    u_coupled = vel_x_p2
    ...
    mu = ${mu1}
    mu_coupled = ${mu2}
    particle_diameter = 5e-3 # Average bubble diameter
    drag_formulation_type = 'mixture'
    drag_model = 'schiller-naumann'
    interphase_drag_name = 'interphase_drag'
  []
[]
...
[Functions]
  ...
  [vel_x_impeller]
    type = ParsedFunction
    expression = '-${rpm} * r * 2*pi/60 * y/r * pump_mass_flow_fraction'
    symbol_names = 'r pump_mass_flow_fraction'
    symbol_values = 'radius pump_mass_flow_fraction'
  []
  [vel_y_impeller]
    type = ParsedFunction
    expression = '${rpm} * r * 2*pi/60 * x/r * pump_mass_flow_fraction'
    symbol_names = 'r pump_mass_flow_fraction'
    symbol_values = 'radius pump_mass_flow_fraction'
  []
  [pump_mass_flow_fraction]
