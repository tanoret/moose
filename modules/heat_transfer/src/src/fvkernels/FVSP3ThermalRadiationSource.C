...
#include "FVSP3ThermalRadiationSource.h"
#include "MathUtils.h"
#include "HeatConductionNames.h"
#include "HeatTransferModels.h"

registerMooseObject("HeatTransferApp", FVSP3ThermalRadiationSource);

InputParameters
FVSP3ThermalRadiationSource::validParams()
{
...
FVSP3ThermalRadiationSource::FVSP3ThermalRadiationSource(const InputParameters & params)
...
ADReal
FVSP3ThermalRadiationSource::computeQpResidual()
{
